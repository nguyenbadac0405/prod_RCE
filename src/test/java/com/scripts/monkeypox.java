...
public class monkeypox extends DriverFactory {
    login login;
    GetDriver link;
    ...
    @Test
    public void monkeypox_create_case() throws Exception {
        Actions action = new Actions(driver);
        excel.setExcelFile("src/test/resources/monkeypox.xlsx", "Sheet1");
        ...
        login.intake("123456");
        Common.waitSec(6);
        new_case_intake.Monkeypox_create_new_case(business, vertical, MG, lab, type, first_name, last_name, DOB, medicare_ID, zipcode);
        Common.waitSec(3);
    ...
    @Test
    public void monkeypox_new_to_assign() throws Exception {
        excel.setExcelFile("src/test/resources/monkeypox.xlsx", "Sheet1");
        login.URL_intake();
        login.pss("111111");
        Common.waitSec(5);
        ...
        to_assign.Monkeypox_to_assign();
        Common.waitSec(5);
    }

    @Test
    public void monkeypox_assign_to_approve() throws Exception {
...
//        Common.waitSec(3);
    ...
    @Test
    public void monkeypox_to_complete() throws Exception {
        excel.setExcelFile("src/test/resources/monkeypox.xlsx", "Sheet1");
        login.URL_intake();
        login.pss("111111");
        Common.waitSec(5);
    ...
    @Test
    public void monkeypox() throws Exception {
        //create new case
        Actions action = new Actions(driver);
        excel.setExcelFile("src/test/resources/monkeypox.xlsx", "Sheet1");
        String business = excel.getCellData("business", 1);
